        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.html" class="logo">Juan Agustin Ordoñez</a></h1>
              <ul>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="colorlib-navbar-brand">
                <a class="colorlib-logo" href="index.html"><span class="logo-img" style="background-image: url(images/person_1.jpg);"></span>Juan Agustin Ordoñez</a>
              </div>
      ...
      <section class="home-slider owl-carousel js-fullheight">
          ...
          <div class="container">
            <div class="row slider-text align-items-center text-center justify-content-center" data-scrollax-parent="true">
              <div class="col-md-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <h1 class="mb-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Juan Agustin Ordoñez</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="slider-item js-fullheight">
          ...
          <div class="container">
            <div class="row slider-text align-items-center text-center justify-content-center" data-scrollax-parent="true">
              <div class="col-md-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <p><a href="#" class="scroll">I'm from The Philippines</a></p>
                <h1 class="mb-3" data-scrollax="properties: {translateY: '30%', opacity: 1.6}">A Future Developer</h1>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row d-flex" data-scrollax-parent="true">
            ...
            <div class="col-md-6 wrap ftco-animate">
              <div class="about-desc">
                ...
                <div class="p-5">
                  <h2 class="mb-5">Hi! Juan Agustin Ordoñez</h2>
                  <p>I'm a student of Asia Pacific College, currently taking the course of BS in Information Technology specialized in Mobile and Internet.</p>
                  ...
                  <p>Email: <a href="#">jsordonez@student.apc.edu.ph</a></p>
                  <p>Phone: <a href="#">+63 9060837540</a></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row mb-5 justify-content-center">
            <div class="col-md-5 text-center">
              ...
              <div class="ftco-footer-widget">
                ...
                <p class="h3 email"><a href="#">jsordonez@student.apc.edu.ph</a></p>
              </div>
            </div>
          </div>
          <div class="row">
